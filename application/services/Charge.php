...
class Charge extends HTY_service
{
    ...
    {
        $field="a.order_id,a.order_autoid,a.order_datetime,a.order_statue,b.activity_id,b.activity_name,b.activity_describe,b.activity_cover,b.activity_beginDate,b.activity_endDate,b.activity_signPrice,b.activity_status,b.activity_signIntegral";
    ...
    public function getOrder($val)
    {
        ...
        if($val['order_refund_flag']!=""){
            ...
            if($val['order_refund_flag'] == '0'){
                ...
                $where_refund=" and a.order_refund_flag in (3,4)";
            }else if($val['order_refund_flag'] == '5'){
                $where_statue=" and (a.order_statue='{$val['order_statue']}'";
