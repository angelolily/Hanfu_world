...
class ReferrerControl extends CI_Controller
{
	...
	{
		$keys="rows,pages,referrer_name,referrer_phone";
		$this->hedVerify($keys);
		$result = $this->referrer->getreferrer($this->dataArr);
		if (count($result) >= 0) {
